...
Currently generates square puzzles
...
class Window(Tk):
    ...
    def generate_puzzle(self):
        ...
        try:
            ...
            mb.showerror("Generation failed", "The algorithm could not place a word. \nTry it again. If the problem persists, try \nmore commonly lettered words")
            return
        ...
        mb.showinfo("Generation complete", "The puzzle was copied to the clipboard. :-)\nPaste into a word processor set for a \nmonospaced font BEFORE closing this program.")
